...
public function index()
{
    ...
    $internships = Internship::with(['applications' => function ($query) use ($user) {
    ...
    public function apply(Request $request, $internshipId)
    {
        ...
        $resumePath = $request->file('documents.resume')->store('applications', 'public');
        $coverLetterPath = $request->file('documents.cover_letter')->store('applications', 'public');
