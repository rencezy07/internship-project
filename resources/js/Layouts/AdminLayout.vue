...
<template>
    <div class="flex h-screen">
        ...
        <aside
            ...
            :class="[
                'fixed top-0 left-0 h-full bg-gray-900 text-white w-64 transform lg:translate-x-0 transition-transform duration-300 z-50',
                { '-translate-x-full': !isSidebarOpen },
            ]"
        >
            <!-- Sidebar Header -->
            <div
                class="text-black bg-gradient-to-r from-[#00FFAB] to-[#00C29A] flex items-center justify-between p-6 border-b border-gray-700"
            >
            ...
            <nav class="mt-6">
                <ul class="space-y-2">
                    <li>
                        ...
                        >
                            <i
                                class="fas fa-tachometer-alt text-[#00FFAB] mr-2"
                            ></i>
                            Dashboard
                        </Link>
                    </li>
                    ...
                    <li>
                        <a
                            href="/admin/student-internship-applications"
                            class="flex items-center px-6 py-3 hover:bg-gray-700 rounded-md transition"
                        >
                            <i
                                class="fas fa-user-graduate text-[#00FFAB] mr-2"
                            ></i>
                            Student Applications
                        </a>
                    </li>
                        ...
                        <ul v-if="isDropdownOpen" class="ml-6 space-y-1 mt-1">
                            <li>
                                <a
                                    ...
                                    class="block px-6 py-2 hover:bg-gray-600 rounded-md"
                                >
                                    <i
                                        class="fas fa-user text-[#00FFAB] mr-2"
                                    ></i>
                                    Students
                                </a>
                            </li>
                            <li>
                                <a
                                    href="/admin/view-companies"
                                    class="block px-6 py-2 hover:bg-gray-600 rounded-md"
                                >
                                    <i
                                        class="fas fa-building text-[#00FFAB] mr-2"
                                    ></i>
                                    Companies
                                </a>
                            </li>
                    ...
                    <li>
                        ...
                        >
                            <i
                                class="fas fa-sign-out-alt text-red-400 mr-2"
                            ></i>
                            Logout
                        </Link>
                    </li>
