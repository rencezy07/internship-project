...
<template>
  <div class="max-w-2xl mx-auto p-6 bg-gradient-to-r from-white to-gray-50 shadow-lg rounded-lg">
    <!-- Profile Header -->
    <div class="text-center mb-6">
      ...
      <p class="text-sm text-gray-500">Update your personal information and settings.</p>
    </div>
  ...
  <div class="mb-4">
    ...
    <div class="mt-6 bg-red-50 p-4 rounded-lg shadow-md">
      ...
      <p class="text-xs text-red-600">This action cannot be undone. Please confirm your password to delete your account.</p>
