...
<template>
  ...
  <div class="form-section">
    ...
    <div class="form-group">
      ...
      <input v-model="form.businessName" type="text" placeholder="Enter the official name of your business" required />
    </div>
    <div class="form-group">
      <label>Owner's Full Name (required):</label>
      <input v-model="form.ownerName" type="text" placeholder="Enter your full name as the business owner or representative" required />
    </div>
    <div class="form-group">
  ...
  <div class="form-section">
    ...
    <div class="form-group">
      ...
      <input type="file" @change="handleFileUpload('businessRegistration', $event)" required />
    </div>
    <div class="form-group">
      <label>Valid ID of Owner/Representative (required):</label>
      <input type="file" @change="handleFileUpload('ownerId', $event)" required />
    </div>
  </div>
  ...
  <div class="form-section">
    ...
    <div class="form-group">
      ...
      <input
        ...
        type="password"
        placeholder="Minimum 8 characters, must include uppercase, lowercase, and a number"
        required
      />
    </div>
    <div class="form-group">
