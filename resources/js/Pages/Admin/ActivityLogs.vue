<template>
    <div class="min-h-screen bg-white text-black p-4">
        ...
        <div class="flex flex-col items-center mb-6">
            <h1
                class="text-3xl font-bold tracking-wide uppercase flex items-center gap-2"
            >
                <i class="fas fa-tasks text-[#00FFAB]"></i> Activity Logs
            </h1>
            <p class="text-gray-500 text-sm mt-1">
                Track all system activities and actions performed
            </p>
        </div>

        <!-- Filters Section -->
        <div
            class="bg-white border border-gray-300 rounded-lg p-4 mb-6 shadow-md"
        >
