<template>
    <div class="p-6 bg-gray-50 min-h-screen">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4 mb-8">
            ...
            >
                <div class="flex items-center space-x-4">
                    <div class="p-4 rounded-full" :class="stat.iconBg">
                        <i :class="stat.icon"></i>
                    </div>
                    <div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div class="bg-white rounded-lg shadow-lg p-6">
                <h2 class="text-xl font-semibold text-[#00FFAB] mb-4">
                    Recent Users
                </h2>
                <ul>
                    <li
                    ...
                    >
                        ...
                        <div>
                            <i
                                class="fas fa-user-circle text-indigo-500 text-2xl"
                            ></i>
                        </div>
                    </li>
                </ul>
            ...
            <div class="bg-white rounded-lg shadow-lg p-6">
                ...
                <ul>
                    ...
                    >
                        ...
                        <div>
                            <i
                                class="fas fa-building text-green-500 text-2xl"
                            ></i>
                        </div>
                    </li>
                </ul>
...
const { recentUsers = [], recentCompanies = [] } = usePage().props;
    ...
    new Chart(applicationsChart.value, {
        ...
        data: {
            ...
            datasets: [
                {
                    data: [
                        props.verifiedCompanies,
                        props.underReviewApplications,
