...
<template>
  <div class="min-h-screen flex items-center justify-center bg-gray-50">
    <!-- Main Container -->
    <div class="flex w-full max-w-8xl bg-white shadow-lg rounded-lg overflow-hidden">
      <!-- Left Side: Image -->
      <!-- Left Image Section -->
      ...
      <div class="w-full md:w-1/2 p-10 flex flex-col justify-center">
        ...
        <img src="/public/images/logo.png" alt="Logo" class="h-15 w-15 " />
      </div>
        <!-- Header -->
        <div class="text-center mb-8">
          <h2 class="text-4xl font-extrabold text-gray-800">Admin Login</h2>
          <p class="text-gray-600 mt-2">Access your admin panel</p>
          <div class="h-1 w-16 bg-[#00FFAB] mx-auto mt-3 rounded"></div>
        </div>
