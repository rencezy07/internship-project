  ...
  <div class="min-h-screen bg-gray-100 flex flex-col items-center py-10 px-4">
    ...
    >
      ...
      <div class="mt-12 text-center">
        <button
          type="submit"
          class="bg-gradient-to-r from-blue-500 to-blue-700 text-white px-8 py-3 rounded-full font-bold text-lg shadow-lg hover:from-blue-600 hover:to-blue-800 transition duration-200 transform hover:scale-105"
        >
          Update Profile
        </button>
      </div>
