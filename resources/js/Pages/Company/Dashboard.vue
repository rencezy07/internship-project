    ...
    <div class="ml-60 space-y-5">
        ...
        <div class="bg-gray-800 p-6 rounded-lg shadow-lg">
            <h1 class="text-2xl font-bold text-white">
                Welcome,
                <span class="text-[#00FFAB]">{{ auth.user.company_name }}</span
                >!
            </h1>
            <p class="text-white">
                Here’s an overview of your internship activities.
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <!-- Total Applications -->
            <div
                class="bg-white p-6 rounded-lg shadow-md flex items-center gap-4"
            >
                ...
                >
                    <div>
                        ...
                        <p class="text-sm text-gray-600">
                            Applicant: {{ application.user.first_name }}
                        </p>
                        <p class="text-sm text-gray-600">
